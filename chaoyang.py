...
#coding=utf-8
import urllib2
poi_file=open("C://Users//Esri//Desktop//poi.txt","a")
for i in range(1,866):#昆明市五华区的poi点数据共11页
    url1="http://www.poi86.com/poi/amap/district/530102/"+str(i)+".html"#昆明市五华区的poi点数据的网址
    try:
    ...
    if page1:
        text1=page1.read()
        for j in range(0,50):#每页有50个POI点的数据
