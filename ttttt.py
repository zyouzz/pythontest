...
line ="编号"+ ',' + "用户名"+ ',' + "威望" + ',' + "积分" + ',' + "赞同" + ',' + "感谢" + ',' + "发问" + ',' + "回复" + ',' + "文章" + ',' + "关注" + ',' + "被关注" + ',' + "关注话题" + ',' +"个人主页" + ',' +"个性主页" +"主页访问量" + '\n'
...
for namecode in range(start,shuliang+1):
    ...
    try:
        ...
        fangwenliang1=soup.findall('span',{'class':'aw-text-color-666'})
        print fangwenliang1
        ...
        fangwenliang=re.sub(r'\s|\n|<span class="aw-text-color-666">|^\d+|<.*>', '', str(fangwenliang1[0]))
        print fangwenliang
        ...
        # print "--------------------------------------------------------------------------------------------------------------------------------------"
        file = open('C://Users//Esri//Desktop//arcgiazhihu.txt', 'a')
        line = str(namecode)+ ',' +str(user_name1)+ ',' + weiwang + ',' + jifen + ',' + zantong+ ',' + ganxie+ ',' + fawen+ ',' + huifu+ ',' + wenzhang+ ',' + guanzhu+ ',' + beiguanzhu+ ',' + guanzhuhuati +',' +gerenzhuye+',' +gexingzhuye+',' +fangwenliang+ '\n'
        # 对象file的write方法将字符串line写入file中
        file = file.write(line)
        num=num+1
    except Exception, e:
